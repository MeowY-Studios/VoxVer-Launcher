...
Object.defineProperty(window, 'electronAPI', {
  value: {
    ...
    instance: {
      ...
      toggleMod: vi.fn().mockResolvedValue(true),
      deleteMod: vi.fn().mockResolvedValue(true),
      diskUsage: vi.fn().mockResolvedValue({ total: 0, mods: 0, saves: 0, resourcepacks: 0, shaderpacks: 0, config: 0, others: 0 }),
      listResourcePacks: vi.fn().mockResolvedValue([]),
      toggleResourcePack: vi.fn().mockResolvedValue(true),
      deleteResourcePack: vi.fn().mockResolvedValue(true),
      listShaderPacks: vi.fn().mockResolvedValue([]),
      toggleShaderPack: vi.fn().mockResolvedValue(true),
      deleteShaderPack: vi.fn().mockResolvedValue(true),
      listSaves: vi.fn().mockResolvedValue([]),
      renameSave: vi.fn().mockResolvedValue(true),
      backupSave: vi.fn().mockResolvedValue('test.zip'),
      deleteSave: vi.fn().mockResolvedValue(true),
      scanMinecraft: vi.fn().mockResolvedValue({ ok: true, data: [] }),
      exportInstance: vi.fn().mockResolvedValue({ ok: true }),
      importInstance: vi.fn().mockResolvedValue({ ok: true }),
      exportPreview: vi.fn().mockResolvedValue({ ok: true, data: { totalSize: 0, files: [] } })
    },
    path: {
      getMinecraft: vi
        .fn()
