...
**VoxVer Launcher - Minecraft Launcher Advanced**
...
>
> - 新仓库地址：https://github.com/nnkmn/VoxVer-Launcher
> - 新 App ID：`com.voxver.launcher`
> - 新自定义协议：`voxver://share:xxxxxx`
> - 新数据库文件：`voxver.db`
>
> 所有功能保持不变，仅品牌标识更新。感谢您的支持！
...
| 版本 | 日期 | 核心内容 |
|------|------|-----------|
| v0.5.5 | 2026-06-22 | P1 任务完成：i18n 国际化全面接入、TypeScript 类型全面修复、UI/UX 优化、ModLoader 安装完善 |
| v0.5.4 | 2026-06-20 | 架构优化（Squirrel 安装器、启动器统一、watcher 完善）+ 性能优化（并行下载、JVM GC 动态参数）+ Bug 修复 + 开发工具完善 |
| v0.5.3 | 2026-06-09 | 稳定性更新 + Bug 修复 + 文档完善，版本列表双层缓存 + 骨架屏优化 |
| v0.5.2 | 2026-06-07 | P2P 实例分享（WebRTC 直连 + 6 位分享码）、主题自定义、TypeScript 类型完善 |
| v0.5.0 | 2026-06-05 | 启动核心修复、多镜像下载、启动器热更新、下载管理页面 |
| v0.4.2 | 2026-06-02 | 代码规范检查、日志级别修正、API Key 安全配置 |
